...
export const PAYMENT_UPDATE_TO_PAID_REQUEST = "PAYMENT_UPDATE_TO_PAID_REQUEST";
export const PAYMENT_UPDATE_TO_PAID_SUCCESS = "PAYMENT_UPDATE_TO_PAID_SUCCESS";
export const PAYMENT_UPDATE_TO_PAID_FAIL = "PAYMENT_UPDATE_TO_PAID_FAIL";
export const PAYMENT_UPDATE_TO_PAID_RESET = "PAYMENT_UPDATE_TO_PAID_RESET";

export const PAYMENT_UPDATE_TO_CANCELLED_REQUEST =
  "PAYMENT_UPDATE_TO_CANCELLED_REQUEST";
export const PAYMENT_UPDATE_TO_CANCELLED_SUCCESS =
  "PAYMENT_UPDATE_TO_CANCELLED_SUCCESS";
export const PAYMENT_UPDATE_TO_CANCELLED_FAIL =
  "PAYMENT_UPDATE_TO_CANCELLED_FAIL";
export const PAYMENT_UPDATE_TO_CANCELLED_RESET =
